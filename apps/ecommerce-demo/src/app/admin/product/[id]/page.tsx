...
import { ARTryOnWidget } from '@ar-project/react-wrapper';
            ...
            <div className="bg-background min-h-screen">
                <div className="container mx-auto px-4 py-8 max-w-7xl">
                    ...
                    <div className="flex items-center gap-4 mb-8 border-b-2 border-border pb-6">
                        <button onClick={() => router.back()} className="p-2 border-2 border-border hover:bg-zinc-100 transition-colors shadow-(--shadow-solid-sm)">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                        ...
                        <div className="lg:col-span-7 space-y-8">
                            <form id="productForm" onSubmit={handleSave} className="bg-white border-2 border-border p-8 shadow-(--shadow-solid-hover) space-y-6">
                                ...
                                <div className="border-t-2 border-border pt-6 mt-6">
                                    <div className="flex items-center justify-between mb-4">
                                        ...
                                        <span className="text-xs font-bold bg-amber-100 text-amber-800 px-3 py-1 border-2 border-amber-900 shadow-(--shadow-solid-sm)">Solo Administradores</span>
                                    </div>
                        ...
                        <div className="lg:col-span-5 flex flex-col gap-6">
                            ...
                            <div className="bg-white border-2 border-border shadow-(--shadow-solid-hover) flex flex-col overflow-hidden relative">
                                <div className="border-b-2 border-border p-3 bg-zinc-100 flex justify-between items-center z-20">
                                    ...
                                    <div className="flex bg-white border-2 border-border shadow-(--shadow-solid-sm) rounded-sm overflow-hidden">
                                        <button
                                            type="button"
                                    ...
                                    {previewMode === '3d' ? (
                                        ...
                                        <>
                                            {!previewModelUrl ? (
                                                ...
                                                <>
                                                    <ARTryOnWidget
                                                        apiKey={process.env.NEXT_PUBLIC_AR_API_KEY || 'test_api_key_123'}
                                                        modelUrl={previewModelUrl || ''}
                                                        onReady={() => {
                                                            setIsFaceTrackerLoaded(true);
                                                            setIsFaceDetected(true);
                                                        }}
                                                        onError={(err: any) => setFaceTrackerError(err.message || 'Error AR')}
                                                        config={{
                                                            scaleFactor: scale,
                                                            offsetX: offsetX,
                                                            offsetY: offsetY,
                                                    ...
                                                    <div className="absolute top-2 left-2 z-10">
                                                        <div className={`text-[9px] font-black uppercase px-2 py-1 flex items-center gap-1.5 border-2 border-border bg-white shadow-(--shadow-solid-sm)`}>
                            ...
                            <button
                                ...
                                form="productForm"
                                disabled={isLoading}
                                className="w-full flex items-center justify-center gap-3 bg-primary text-white py-4 border-2 border-border shadow-(--shadow-solid-btn) hover:-translate-y-1 hover:shadow-(--shadow-solid-hover) active:translate-y-0 active:shadow-none transition-all disabled:opacity-50 font-black uppercase text-lg"
                            >
